...
function relationship_add( $p_src_bug_id, $p_dest_bug_id, $p_relationship_type, $p_email_for_source = true ) {
	...
	$t_timestamp = db_now();
	bug_date_update( $p_src_bug_id, $t_timestamp );
	bug_date_update( $p_dest_bug_id, $t_timestamp );
...
function relationship_delete( $p_relationship_id, $p_send_email = true ) {
	...
	$t_timestamp = db_now();
	bug_date_update( $t_src_bug_id, $t_timestamp );
	bug_date_update( $t_dest_bug_id, $t_timestamp );
